...
- [`/ask`](/docs/cli-reference/ask) — Ask a question, answered from your project docs
- [`/html`](/docs/cli-reference/html) — Build a browsable single-file HTML viewer for the docs
