...
export const searchData: SearchItem[] = [
  ...
  { title: "/prompt", description: "Turn a task into an optimized, file-referencing prompt for another AI", href: "/docs/cli-reference/prompt", category: "CLI Reference", keywords: ["prompt", "optimize", "claude", "kiro", "cursor", "tokens", "task", "generate prompt"] },
  { title: "/ask", description: "Ask a question about your project, answered from its docs", href: "/docs/cli-reference/ask", category: "CLI Reference", keywords: ["ask", "question", "q&a", "docs", "answer", "query", "knowledge base"] },
  { title: "/html", description: "Build a browsable single-file HTML viewer for your docs — free, no tokens", href: "/docs/cli-reference/html", category: "CLI Reference", keywords: ["html", "viewer", "browser", "search", "sidebar", "mermaid", "diagrams", "docs.html", "export", "share"] },
  ...
  { title: "v0.3.0", description: "Docs You Can Browse — new /html single-file docs viewer, /sync fence-corruption fix", href: "/docs/changelog/v0.3.0", category: "Changelog", keywords: ["0.3.0", "html", "viewer", "browser", "search", "mermaid", "sync", "fence", "fix"] },
  { title: "v0.2.1", description: "Ask Your Docs — new /ask command, terminal Markdown rendering, terminal-freeze fix", href: "/docs/changelog/v0.2.1", category: "Changelog", keywords: ["0.2.1", "ask", "q&a", "markdown", "render", "freeze", "fix", "docs"] },
  { title: "v0.2.0", description: "Prompts That Travel — new /prompt command for optimized cross-AI prompts", href: "/docs/changelog/v0.2.0", category: "Changelog", keywords: ["0.2.0", "prompt", "optimize", "claude", "kiro", "cross-ai", "tokens"] },
